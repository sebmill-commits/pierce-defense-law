...
import { SEATTLE_SITE_CONFIG, SEATTLE_COURT_PRICING } from "@/lib/seattle-constants";

export const metadata: Metadata = {
  title: "Traffic Ticket Lawyer Seattle | King County Traffic Defense",
  description:
    "Fight your traffic ticket in Seattle and King County. Flat fee defense starting at $149. I handle court so you don't miss work.",
  openGraph: {
    title: "Traffic Ticket Defense | Rivercrest Law Seattle",
    description:
      "Keep points off your record. Flat fee traffic ticket defense in Seattle and King County.",
  },
};

export default function SeattleTrafficTicketsPage() {
  const ticketTypes = [
    {
      icon: Gauge,
  ...
  // Seattle/King County courts for pricing display
  const sampleCourts = [
                ...
                {sampleCourts.map((court) => (
                  <tr key={court}>
                    ...
                    <td className="px-4 py-3 text-right text-sm font-semibold text-emerald-600">
                      ${SEATTLE_COURT_PRICING[court]?.base || 199}
                    </td>
                  </tr>
                ))}
              </tbody>
