...
export const metadata: Metadata = {
  title: "DUI Defense Attorney Seattle | King County DUI Lawyer",
  description:
    "Facing a DUI in Seattle or King County? I challenge the stop, the tests, and the evidence. Available 24/7 for emergencies. Free consultation.",
  openGraph: {
    title: "DUI Defense Attorney | Rivercrest Law Seattle",
    description:
      "Experienced DUI defense in Seattle and King County. I challenge every aspect of your case.",
  },
};

export default function SeattleDUIDefensePage() {
  const consequences = [
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              {
                "@type": "Question",
                name: "What is the cost of a DUI defense attorney in Seattle?",
                acceptedAnswer: {
                  "@type": "Answer",
