...
export const metadata: Metadata = {
  title: "About Sebastian Miller | Pierce Defense Law | Tacoma Attorney",
  description:
    "Meet Sebastian Miller, trial attorney serving Pierce County. Aggressive defense with personal attention. Learn about my approach and experience.",
  openGraph: {
    title: "About Sebastian Miller | Pierce Defense Law",
    description:
      "Trial attorney focused on traffic and DUI defense in Pierce County.",
  },
};
    ...
    <main className="min-h-screen">
      ...
      <section className="bg-slate-900 px-4 py-16 text-white lg:py-24">
        <div className="mx-auto max-w-4xl">
          ...
          >
            About {SITE_CONFIG.attorneyName}
          </h1>
          <p className="text-lg text-slate-300 lg:text-xl">
            {SITE_CONFIG.attorneyTitle} &bull; {SITE_CONFIG.name}
          </p>
        </div>
      </section>
